...
@property (weak, nonatomic) id<TWSCloseViewDelegate> closeDelegate;
...
@protocol TWSCloseViewDelegate <NSObject>

@optional
- (void)releaseNotes:(TWSReleaseNotesView *)releaseView closeClicked:(BOOL)clicked;
